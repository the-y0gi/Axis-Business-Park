  ...
  return (
    <section id="overview" className="py-24 max-w-7xl mx-auto px-6">
      <div className="flex justify-between items-end mb-12  border-white/10 pb-6">
        <h2 className="text-3xl text-black font-light">Development Overview</h2>
        <ArrowRight className="text-[#ff5e00] w-8 h-8" />
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {SITE_CONTENT.overview.map((item, idx) => (
          <div key={idx} className="group">
            ...
            <button className="px-6 py-2 rounded  text-[#ff5e00] border border-[#ff5e00]/30 text-xs font-bold uppercase tracking-widest hover:bg-[#ff5e00] hover:text-black transition-all flex items-center gap-2">
