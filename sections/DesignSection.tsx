...
export default function DesignSection() {
  return (
    <section id="design" className="py-24 border-t border-black/5 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-12">
          <p className="text-zinc-600 text-xs uppercase tracking-widest mb-2">
            Where Proven Capability meets
          </p>
          <h2 className="text-4xl md:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#ff8a34] to-[#ff5e00] uppercase">
            Exceptional Industrial Design
          </h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-4 h-[900px] md:h-[600px]">
          <div className="md:col-span-2 md:row-span-2 relative rounded-xl overflow-hidden group bg-black">
            <img
          ...
          <div className="md:col-span-2 md:row-span-1 bg-zinc-50 p-8 flex flex-col justify-center border border-black/5 rounded-xl">
            <h3 className="text-[#ff5e00] text-xs font-bold uppercase tracking-widest mb-4">
              Experience
            </h3>
          ...
          <div className="md:col-span-1 md:row-span-1 bg-zinc-50 rounded-xl flex items-center justify-center border border-black/5">
            <img
